...
public class DirectoryLister {
    ...
    private String traverseFiles(final List<? extends FileView> files,
            final FileFilter filter, final FileFormatter formater) {
    ...
    public String listFiles(final ListArgument argument,
            final FileSystemView fileSystemView, final FileFormatter formater)
            throws IOException {
